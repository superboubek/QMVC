...
void Shader::loadFromFile (const string & vertexShaderFilename, const string & fragmentShaderFilename, const string & geometryShaderFilename,
...
void Shader::bind ( bool andSay ) const {
    // glLinkProgram (shaderProgram);
...
GLint Shader::getUniLoc (GLuint program, const GLchar *name) const {
    GLint loc = glGetUniformLocation (program, name);

    return loc;
}

GLint Shader::getAttributLoc (GLuint program, const GLchar *name)
{
